...
module.exports = BotWhatsaap.addKeyword('22')
    .addAnswer(
        ['PODERES COLECTIVOS',
            '',
            ...
            '● Fotocopia y Original de la Cédula de Identidad boliviana VIGENTE DE LOS PODERDANTES en caso de alguno ser de nacionalidad Brasilera presentar RG brasilero o Pasaporte',
